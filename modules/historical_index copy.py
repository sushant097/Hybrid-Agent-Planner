...
def load_similar_examples(user_query: str, top_k: int = 3, memory_root: Optional[str] = None):
...
def find_best_cached_answer(
    ...
    is a paraphrase of any past query.
    """
    index_path = Path(memory_root) / "historical_conversation_store.json"
    index = _load_index(index_path)
